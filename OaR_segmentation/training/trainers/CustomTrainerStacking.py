...
class CustomTrainerStacking(NetworkTrainer):
    ...
    def validate(self, *args, **kwargs):
        ...
        self.print_to_log_file(f"The real validation loss is {self.all_val_eval_metrics[-1]}")
    ...
    def update_tsboard(self):
        ...
        self.writer.add_scalar(tag='Loss/custom_validation', scalar_value=self.all_val_eval_metrics[-1],
    ...
    def update_json_train(self):
        temp_dict = {self.epoch:
                         {"validation_loss": float(self.all_val_losses[-1]),
                          ...
                          "loss_custom_val": float(self.all_val_eval_metrics[-1]),
